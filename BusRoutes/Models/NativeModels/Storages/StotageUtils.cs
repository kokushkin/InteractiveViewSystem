...
namespace BusRoutes.Models.NativeModels.Storages
{
    public class StotageUtils
    {
        public static void GenerateTestDataAndSave()
        {
            ...
            stationsRoute11.Add(new Station(235235, 1, "Ivanovo", GetTodayDateTime(9, 45), null, "Ivanovo station. 5 min."));

            stationsRoute11.Add(new Station(945853, 2, "Airport", GetTodayDateTime(9, 50), null, "Airport station. 15 min."));

            stationsRoute11.Add(new Station(124590, 3, "Lake", GetTodayDateTime(10, 10), null, "Lake station. 5 min. Temporarily closed."));

            stationsRoute11.Add(new Station(744935, 4, "Central station.", GetTodayDateTime(10, 30), null, "Central station. 7 min."));
