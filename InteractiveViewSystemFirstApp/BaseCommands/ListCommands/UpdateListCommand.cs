...
{
    public class UpdateListCommand<DataModelType, DataViewModelType, DataDetailViewModelType>
    ...
    {
        public UpdateListCommand(ListViewModel<DataModelType, DataViewModelType, DataDetailViewModelType> listVM)
            :base(listVM) {}

        public bool CanExecute(object parameter)
        {
            return _listVM.CanUpdateList();
        }
